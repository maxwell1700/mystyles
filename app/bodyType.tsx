...
export default function BodyTypeScreen() {
  return (
    <View style={styles.container}>
      ...
      {/* <Image source={images.onboarding4} style={styles.image} resizeMode="contain" /> */}
      <Text style={styles.description}>Choose the body type that best matches you for more accurate outfit suggestions.</Text>
